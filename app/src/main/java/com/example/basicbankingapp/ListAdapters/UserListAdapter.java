...
public class UserListAdapter extends RecyclerView.Adapter<UserListAdapter.ViewHolder> {
    ...
    public  class ViewHolder extends RecyclerView.ViewHolder {
        TextView userName, userAccountBalance,userEmail;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            userEmail = itemView.findViewById(R.id.emailAddress);
    ...
    public void onBindViewHolder(@NonNull UserListAdapter.ViewHolder viewHolder, int position) {
        ...
        viewHolder.userEmail.setText(userArrayList.get(position).getEmail());
